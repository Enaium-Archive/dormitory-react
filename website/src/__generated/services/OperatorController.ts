...
export class OperatorController {
  ...
  async delete(options: OperatorControllerOptions["delete"]): Promise<ResponseBody<Void | undefined>> {
    let _uri = "/operator/"
  ...
  async get(
    options: OperatorControllerOptions["get"],
  ): Promise<ResponseBody<Page<OperatorDto["OperatorController/DEFAULT_FETCHER"]> | undefined>> {
    let _uri = "/operator/"
    ...
    return (await this.executor({ uri: _uri, method: "GET" })) as ResponseBody<
      Page<OperatorDto["OperatorController/DEFAULT_FETCHER"]> | undefined
    >
  }

  async put(options: OperatorControllerOptions["put"]): Promise<ResponseBody<Void | undefined>> {
    let _uri = "/operator/"
